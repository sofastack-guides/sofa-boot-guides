...
public class SofaBootWithModulesTest {
    ...
    @Test
    public void test() {
        Assertions.assertEquals("Hello, jvm service xml implementation.", sampleJvmService.message());
        Assertions.assertEquals("Hello, jvm service annotation implementation.",
            sampleJvmServiceAnnotationImpl.message());
        Assertions.assertEquals("Hello, jvm service service client implementation.",
